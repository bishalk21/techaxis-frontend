    ...
    <div className="footer">
      <div className="subfooter">
        <div className="Payment_methods">
          <img
            src="https://i.imgur.com/DQ26UNt.png"
            className="payement_method"
            alt="paypal"
          />
          <img
            src="https://i.imgur.com/wwAm2Kf.png"
            className="payement_method"
            alt="Visa"
          />
          <img
            src="https://i.imgur.com/1jOWC2T.png"
            className="payement_method"
            alt="MasterCard"
          />
          <img
            src="https://i.imgur.com/4hSZUH2.png"
            className="payement_method"
            alt="Stripe"
          />
        </div>{" "}
      ...
      <div className="logo_copyright">
        <img alt="EDUSPACE" src={aa} className="footer_logo" />
        <div className="copyright">
          <p>
            {" "}
            &copy;
            {/* current data */}
            {new Date().getFullYear()} <span>TECHAXIS</span> All rights
            reserved.{" "}
          </p>{" "}
        </div>{" "}
      </div>
